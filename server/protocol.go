...
// set is advertised during the initialize handshake and used to negotiate the
// version with the client.
type ProtocolVersion = string

// Supported MCP protocol versions, newest first. The first element is the
// latest and is used as the fallback when a client does not request a specific
// version.
const (
...
// element is the negotiation fallback (see methods.Initialize).
...
// Capability keys advertised to clients during initialize.
const (
